...
-- ------------------------------------------------------------
INSERT INTO `user` (`id`, `username`, `password`, `nickname`, `phone`, `email`, `role`, `status`, `create_time`, `update_time`) VALUES
(1, 'admin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '系统管理员', NULL, 'admin@library.com', 'ADMIN', 1, NOW(), NOW()),
(2, 'librarian', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '馆员小王', '13800138001', 'librarian@library.com', 'LIBRARIAN', 1, NOW(), NOW()),
(3, 'user01', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '测试用户', '13800138002', 'user01@example.com', 'USER', 1, NOW(), NOW());
...
-- 4. 自习室
-- ------------------------------------------------------------
INSERT INTO `study_room` (`id`, `name`, `location`, `capacity`, `open_time`, `status`, `create_time`, `update_time`) VALUES
(1, 'A区自习室', '图书馆一楼A区', 20, '08:00-22:00', 1, NOW(), NOW()),
(2, 'B区自习室', '图书馆二楼B区', 30, '08:00-22:00', 1, NOW(), NOW());
