...
public class BookAdminController {
    ...
    @OperationLog("新增图书")
    @Operation(summary = "录入图书基础信息：用于借阅资源准备")
    @PostMapping("/add")
    ...
    @OperationLog("修改图书")
    @Operation(summary = "维护图书基础信息：分类、库存、封面和描述")
    @PostMapping("/update")
    ...
    @Operation(summary = "馆藏图书分页：用于后台核对借阅资源")
    @GetMapping("/page")
    ...
    @Operation(summary = "馆藏图书详情：查看库存与展示信息")
    @GetMapping("/{id}")
    ...
    @OperationLog("图书上下架")
    @Operation(summary = "调整图书借阅可用状态：控制是否出现在用户端查询")
